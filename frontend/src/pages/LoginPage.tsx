      ...
      <div className="w-full max-w-md">
        <div className={`rounded-2xl shadow-xl p-8 border ${
          ...
          <div className="text-center mb-8">
            <h1 className={`text-2xl font-bold ${theme === "dark" ? "text-white" : "text-slate-900"}`}>Welcome back</h1>
            <p className={`mt-2 ${theme === "dark" ? "text-slate-400" : "text-slate-500"}`}>Sign in to your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className={`text-sm ${theme === "dark" ? "text-slate-300" : "text-slate-600"}`}>Remember me</span>
              </label>
              <a
                href="#"
